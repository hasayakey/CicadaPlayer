...
//                addSwitch.userInteractionEnabled = NO;
        ...
        //containView1
        NSArray *textFieldTitleArray = @[
            NSLocalizedString(@"启播缓冲时长", nil), NSLocalizedString(@"卡顿恢复", nil), NSLocalizedString(@"最大缓冲时长", nil),
            NSLocalizedString(@"直播最大延迟", nil), NSLocalizedString(@"网络超时", nil), NSLocalizedString(@"请求refer", nil),
            NSLocalizedString(@"httpProxy代理", nil), NSLocalizedString(@"重连次数", nil), NSLocalizedString(@"后向buffer最大值", nil)
        ];
